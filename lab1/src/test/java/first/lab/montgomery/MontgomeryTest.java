...
public class MontgomeryTest {
    ...
    public void multiplication() {
        ...
        assertEquals(new BigInteger("23456787654321").multiply(new BigInteger("4567890876543245")).mod(new BigInteger("34567898761")),
                     Montgomery.multiplication(new BigInteger("23456787654321"), new BigInteger("4567890876543245"), new BigInteger("34567898761")));
    }
